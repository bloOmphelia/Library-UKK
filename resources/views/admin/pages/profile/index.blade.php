...
@push('styles')
    <link rel="stylesheet" href="{{ asset('assets/css/admin/profile/index.css') }}">
@endpush
        ...
        <div class="col-lg-10">
            <div class="profile-update-card">
                <div class="profile-header-accent">
                    <h5 class="mb-0 fw-bold text-center"><i class="bi bi-person-gear me-2"></i> Perbarui Profil Admin</h5>
                </div>
