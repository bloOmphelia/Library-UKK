...
<link rel="stylesheet" href="{{ asset('assets/css/admin/books/show.css') }}">
@endpush
    ...
    <div class="detail-grid">
        ...
        <div class="info-col">
            ...
            <div class="desc-section">
                <h4>Sinopsis Buku</h4>
                <p class="desc-text {{ Str::length($book->description ?? '') > 300 ? 'clamped' : '' }}"
                   id="descText">
...
@push('scripts')
@include('admin.pages.books.scripts.show')
@endpush